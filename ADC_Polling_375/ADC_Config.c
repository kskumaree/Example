...
#define AN1           1                                   /* Channel ID for pin AN1                          */
#define AN2           2                                   /* Channel ID for pin AN2                          */
#define AN3           3                                   /* Channel ID for pin AN3                          */
...
uint8 g_grp8channels[CHANNELS_NUM] = {AN1, AN2, AN3};
...
unsigned int adc_1_result;
unsigned int adc_2_result;
unsigned int adc_3_result;
...
void initEVADCGroup()
{
    ...
    /* Setting user configuration using group  */
...
void readEVADC()
{
    for(uint8 i = 0; i < CHANNELS_NUM; i++)
    {
        ...
        adc_1_result = g_results[0].B.RESULT;//R Phase
        adc_2_result = g_results[1].B.RESULT;//Y Phase
        adc_3_result = g_results[2].B.RESULT;//B Phase
